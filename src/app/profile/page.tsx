...
export default function Profile() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 sm:pt-18 lg:px-8">
      <form className="divide-y divide-gray-900/10" method="PUT" onSubmit={handleProfileInfoUpdate}>
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2 flex items-center gap-x-3">
                {(image !== '' && image != undefined) ? (
                  <img className="h-12 w-12 rounded-full ring-2 ring-gray-200" src={image} alt="" />
                ) : (
                ...
                <label htmlFor="file-upload" className="rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 select-none hover:bg-gray-50">
                  Change
                </label>
